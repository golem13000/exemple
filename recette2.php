...
<h1 class="recipe-head"><?= $recette2["titre"] ?></h1>
        
<div class="illustration img-block"><a href="entree2.html"><img src="img/<?= $recette2["image"] ?>" alt="Illustration de la recette <?= $recette2["titre"] ?>">
</a></div>
...
<section class="row bg-light">
    <div class="col-6">
        <table>
            ...
            <tr>
                <td><?= $recette2["temps"] ?></td>
                <td><?= $recette2["personnes"] ?></td>
                <td><?= $recette2["difficulte"] ?>/4</td>
                <td><?= $recette2["cout"] ?>/4</td>
            </tr>
        </table>

        <h2>Ingrédients</h2>
        <?= $recette2["ingredients"] ?>
        <!-- <ul>
